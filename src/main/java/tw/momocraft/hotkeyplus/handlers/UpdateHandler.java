...
public class UpdateHandler {
    ...
    private final String plugin = "hotkeyplus";
    private final int PROJECTID = 85995;

    private final String versionExact = HotkeyPlus.getInstance().getDescription().getVersion();
    ...
    public UpdateHandler() {
        this.checkUpdates(HotkeyPlus.getInstance().getServer().getConsoleSender());
    }
